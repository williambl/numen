...
object BattleGod: God() {
    override val pointOfInterestType: PointOfInterestType = PointOfInterestHelper.register(id("battle_altar"), 0, 1, Gods.BATTLE_ALTAR)
    ...
    override fun evaluate(offering: ItemStack): Double {
        ...
        if (offering.isIn(FabricToolTags.SWORDS) || offering.isIn(FabricToolTags.AXES) || offering.item is RangedWeaponItem) {
